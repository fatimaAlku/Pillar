...
class AppStrings {
  ...
  String get emailRequired => _isArabic ? 'البريد الإلكتروني مطلوب' : 'Email is required';
  String get enterValidEmail => _isArabic ? 'أدخل بريدًا إلكترونيًا صحيحًا' : 'Enter a valid email';
  String get passwordRequired => _isArabic ? 'كلمة المرور مطلوبة' : 'Password is required';
  String get minimumSixChars => _isArabic ? '6 أحرف على الأقل' : 'Minimum 6 characters';
  String get signUp => _isArabic ? 'إنشاء حساب' : 'Sign up';
  String get alreadyHaveAccountLogin =>
      _isArabic ? 'لديك حساب بالفعل؟ سجّل الدخول' : 'Already have an account? Login';
  ...
  String get smallStepsConsistentProgress =>
      _isArabic ? 'خطوات صغيرة وتقدم مستمر.' : 'Small steps, consistent progress.';
  ...
  String get todaysStudyPlan => _isArabic ? 'خطة دراسة اليوم' : 'Today’s study plan';
  String get aiSuggestion => _isArabic ? 'اقتراح الذكاء الاصطناعي' : 'AI suggestion';
  ...
  String minutesShort(int minutes) => _isArabic ? '$minutes دقيقة' : '$minutes min';
  ...
  String scheduleMeta(String subject, int durationMin) =>
      _isArabic ? '$subject  •  $durationMin دقيقة' : '$subject  •  $durationMin min';
  ...
  String get quizzesIntro =>
      _isArabic ? 'أنشئ اختبارات بالذكاء الاصطناعي واستهدف نقاط الضعف أسرع.' : 'Build AI-powered quizzes and target weak topics faster.';
  ...
  String get topicsHint =>
      _isArabic ? 'مثال: أشجار، رسوم بيانية، تجزئة' : 'e.g. Trees, Graphs, Hashing';
  String get notesOptional => _isArabic ? 'الملاحظات (اختياري)' : 'Notes (optional)';
  String get notesHint =>
      _isArabic ? 'الصق الملاحظات لتوفير سياق إنشاء الاختبار' : 'Paste notes for quiz generation context';
  ...
  String get numberOfQuestions => _isArabic ? 'عدد الأسئلة' : 'Number of questions';
  ...
  String get noQuizLoaded =>
      _isArabic ? 'لا يوجد اختبار بعد. أنشئ اختبارًا من تبويب الاختبارات.' : 'No quiz loaded yet. Generate one from the Quiz tab.';
  String get generatingQuizWithAi =>
      _isArabic ? 'جارٍ إنشاء الاختبار بالذكاء الاصطناعي...' : 'Generating quiz with AI...';
  String get retryGeneration => _isArabic ? 'إعادة المحاولة' : 'Retry generation';
  ...
  String get noWeakTopics =>
      _isArabic ? 'لا توجد مواضيع ضعيفة - عمل رائع.' : 'No weak topics detected — great job.';
  String get review => _isArabic ? 'المراجعة' : 'Review';
  String incorrectCount(int count) => _isArabic ? '$count إجابات خاطئة' : '$count incorrect';
  String yourAnswer(String answer) => _isArabic ? 'إجابتك: $answer' : 'Your answer: $answer';
  String correctAnswer(String answer) =>
      _isArabic ? 'الإجابة الصحيحة: $answer' : 'Correct answer: $answer';
  String explanation(String text) => _isArabic ? 'الشرح: $text' : 'Explanation: $text';
  String get unanswered => _isArabic ? 'بدون إجابة' : 'Unanswered';
  String get backToQuizzes => _isArabic ? 'العودة للاختبارات' : 'Back to quizzes';
  ...
  String get priorityRoadmap => _isArabic ? 'خارطة طريق الأولويات' : 'Priority roadmap';
  ...
  String get passwordChange => _isArabic ? 'تغيير كلمة المرور' : 'Password change';
  ...
  String get allRightsReserved =>
      _isArabic ? '© 2026 بيلار. جميع الحقوق محفوظة.' : '© 2026 Pillar. All rights reserved.';
  ...
  String todayTaskReviewCellularRespiration() =>
      _isArabic ? 'مراجعة: التنفس الخلوي' : 'Review: Cellular respiration';
  String todayTaskPracticeQuizThermodynamics() =>
      _isArabic ? 'تدريب اختبار: الديناميكا الحرارية' : 'Practice quiz: Thermodynamics';
  String todayTaskReadNotesChapterSeven() =>
      _isArabic ? 'قراءة الملاحظات: الفصل 7' : 'Read notes: Chapter 7';
}
